  ...
  # DQN Agent
    ...
    def advising_action(self,state,possible_action):
        ...
        if len(possible_action) == 1:
            ...
            if Q_value[possible_action[0]] > Q_value[possible_action[1]]:
                action = possible_action[0]
            else:
    ...
    def give_advise(self,state):
        ...
        for line in lines:
            ...
            done1 = int(p4[3])
            if current_time1<70 and self.cal_similarity(last_state1,state) > similar_threshold:
